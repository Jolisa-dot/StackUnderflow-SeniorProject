...
def analyze():
    """Endpoint to analyze journal entry."""
    ...
    if text:
        ...
        harmful_language = detect_harmful_language(text)
        return jsonify({
            'analysis': analysis,
            'harmful_language_detected': harmful_language
        })
    else:
...
if __name__ == "__main__":
    ...
    app.run(debug=True, host='0.0.0.0', port=5001)  # <-- This starts the Flask app on port 5001
